...
<img src="https://zh-v2.d2l.ai/_images/skip-gram.svg" width=50%>
...
<img src="https://zh-v2.d2l.ai/_images/cbow.svg" width=50%>
...
<p><font size="5px">$\log\,P(w_c \mid \mathcal{W}_o) = \mathbf{u}_c^\top \bar{\mathbf{v}}_o - \log\,\left(\sum_{i \in \mathcal{V}} \exp\left(\mathbf{u}_i^\top \bar{\mathbf{v}}_o\right)\right)$</font>
